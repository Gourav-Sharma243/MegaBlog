                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <div className="flex items-center justify-between mt-1">
                                        ...
                                        {!userData?.emailVerification && (
                                            <button
                                                ...
                                                className="inline-flex items-center px-3 py-1 bg-orange-600 hover:bg-orange-700 disabled:bg-orange-400 text-white text-sm font-medium rounded-lg transition-colors"
                                            >
                                                {isVerifying ? (
                                                    <>
                                    ...
                                    {verificationMessage && (
                                        <div className={`mt-2 p-3 rounded-lg text-sm ${verificationMessage.includes('sent') 
