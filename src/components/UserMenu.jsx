...
function UserMenu() {
    ...
    return (
        <div className="relative px-2 sm:px-0" ref={dropdownRef}>
            <button
            ...
            {isOpen && (
                <div className="absolute right-2 sm:right-0 left-2 sm:left-auto mt-2 w-auto sm:w-56 max-w-xs bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 z-50">
                    ...
                    <div className="py-1 sm:py-2">
                        ...
                        >
                            <svg className="w-3 sm:w-4 h-3 sm:h-4 mr-2 sm:mr-3 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="border-t border-gray-200 dark:border-gray-700 my-1 sm:my-2"></div>
                        <button
                            onClick={() => {
                                setIsOpen(false)
                                logoutHandler()
                        ...
                        >
                            <svg className="w-3 sm:w-4 h-3 sm:h-4 mr-2 sm:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
