  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-gray-900 px-4">
      <div className="mx-auto w-full max-w-lg bg-white dark:bg-gray-800 rounded-xl p-10 border border-black/10 dark:border-gray-700 shadow-md">
        ...
        {error && (
          <p className="text-red-600 mt-6 text-center font-medium" role="alert">
            {error}
          </p>
        )}
        <form onSubmit={handleSubmit(login)} className="mt-8">
          <div className="space-y-6">
            ...
            />
            {errors.email && (
              <p className="text-red-600 text-sm mt-1 pl-1" role="alert">{errors.email.message}</p>
            )}
            <Input
              label="Password:"
              type="password"
            ...
            />
            {errors.password && (
              <p className="text-red-600 text-sm mt-1 pl-1" role="alert">{errors.password.message}</p>
            )}
            <Button
              type="submit"
              className="w-full"
